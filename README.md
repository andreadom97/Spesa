...
| [`design/sistema/DESIGN.md`](design/sistema/DESIGN.md) | **Il design system**, v3 del 20/09/2026: principi, token, tipografia, spaziatura, raggi, bordi, ombre, icone, movimento, 29 componenti con anatomia e misure, pattern, copy, accessibilità, decisioni. Fonte di verità unica per il disegno |
| [`docs/superpowers/specs/DESIGN-SYSTEM.md`](docs/superpowers/specs/DESIGN-SYSTEM.md) | Il design system **visto dal codice**: dove vive ogni componente, le derive misurate su `src/`, le regole per chi scrive codice. Dal 21/09 non ripete più le regole di `DESIGN.md` |
