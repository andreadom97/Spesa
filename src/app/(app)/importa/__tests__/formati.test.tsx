...
describe('Formati', () => {
  ...
  it('"usa l\'ingrediente esistente" offre solo esistenti con unità compatibile, e la scelta rinomina la proposta', async () => {
    const LATTE_ESISTENTE: Ingredient = { id: 'i-latte', nome: 'Latte intero', unitaBase: 'ml', area: 'latticini', classeResiduo: 'porzionabile', deperibile: true, formatoConfezione: 1000 , prezzoConfezione: null, ean: null};
    const PARMIGIANO_ESISTENTE: Ingredient = { id: 'i-parm', nome: 'Parmigiano', unitaBase: 'g', area: 'latticini', classeResiduo: 'porzionabile', deperibile: true, formatoConfezione: 200 , prezzoConfezione: null, ean: null};
