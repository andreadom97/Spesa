...
/**
 * La porta dell'app, prima dell’accesso: fuori dal Guscio, quindi senza Testata nÃ© tab bar
 * (spec fase 6 §C). Marchio e nome, poi il Campo di testo e il Tasto primario di §8. Dopo
 * l’invio dice a quale indirizzo Ã¨ partito il link: un refuso si vede subito, e USA
